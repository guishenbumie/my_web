...
public class CheckBannedUserResponse implements org.apache.thrift.TBase<CheckBannedUserResponse, CheckBannedUserResponse._Fields>, java.io.Serializable, Cloneable, Comparable<CheckBannedUserResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CheckBannedUserResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new CheckBannedUserResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CheckBannedUserResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CheckBannedUserResponse.class, metaDataMap);
  }

  public CheckBannedUserResponse() {
  }
   ...
   */
  public CheckBannedUserResponse(CheckBannedUserResponse other) {
  ...
  public CheckBannedUserResponse deepCopy() {
    return new CheckBannedUserResponse(this);
  }
  ...
  public CheckBannedUserResponse setBase(BaseResp base) {
    this.base = base;
    return this;
  }
  ...
  public CheckBannedUserResponse setIsBanned(boolean isBanned) {
    this.isBanned = isBanned;
    setIsBannedIsSet(true);
    return this;
  }
  ...
  public CheckBannedUserResponse setBeginBanTime(long beginBanTime) {
    this.beginBanTime = beginBanTime;
    setBeginBanTimeIsSet(true);
    return this;
  }
  ...
  public CheckBannedUserResponse setEndBanTime(long endBanTime) {
    this.endBanTime = endBanTime;
    setEndBanTimeIsSet(true);
    return this;
  }
  ...
  public CheckBannedUserResponse setExtra(Map<String,String> extra) {
    this.extra = extra;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CheckBannedUserResponse)
      return this.equals((CheckBannedUserResponse)that);
    return false;
  }

  public boolean equals(CheckBannedUserResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CheckBannedUserResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CheckBannedUserResponse(");
    boolean first = true;
  ...
  private static class CheckBannedUserResponseStandardSchemeFactory implements SchemeFactory {
    public CheckBannedUserResponseStandardScheme getScheme() {
      return new CheckBannedUserResponseStandardScheme();
    }
  }

  private static class CheckBannedUserResponseStandardScheme extends StandardScheme<CheckBannedUserResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CheckBannedUserResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extra = new HashMap<String,String>(2*_map50.size);
                String _key51;
                String _val52;
                for (int _i53 = 0; _i53 < _map50.size; ++_i53)
                {
                  ...
                  struct.extra.put(_key51, _val52);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CheckBannedUserResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.extra != null) {
        oprot.writeFieldBegin(EXTRA_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter54 : struct.extra.entrySet())
          {
  ...
  private static class CheckBannedUserResponseTupleSchemeFactory implements SchemeFactory {
    public CheckBannedUserResponseTupleScheme getScheme() {
      return new CheckBannedUserResponseTupleScheme();
    }
  }

  private static class CheckBannedUserResponseTupleScheme extends TupleScheme<CheckBannedUserResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CheckBannedUserResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetExtra()) {
        {
          ...
          for (Map.Entry<String, String> _iter55 : struct.extra.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CheckBannedUserResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.extra = new HashMap<String,String>(2*_map56.size);
          String _key57;
          String _val58;
          for (int _i59 = 0; _i59 < _map56.size; ++_i59)
          {
            ...
            struct.extra.put(_key57, _val58);
          }
        }
        struct.setExtraIsSet(true);
      }
