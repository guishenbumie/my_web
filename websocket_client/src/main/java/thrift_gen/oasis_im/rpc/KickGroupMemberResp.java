...
public class KickGroupMemberResp implements org.apache.thrift.TBase<KickGroupMemberResp, KickGroupMemberResp._Fields>, java.io.Serializable, Cloneable, Comparable<KickGroupMemberResp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("KickGroupMemberResp");
  ...
  static {
    schemes.put(StandardScheme.class, new KickGroupMemberRespStandardSchemeFactory());
    schemes.put(TupleScheme.class, new KickGroupMemberRespTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(KickGroupMemberResp.class, metaDataMap);
  }
   ...
   */
  public KickGroupMemberResp(KickGroupMemberResp other) {
    if (other.isSetBase()) {
  ...
  public KickGroupMemberResp deepCopy() {
  ...
  public KickGroupMemberResp setBase(BaseResp base) {
    this.base = base;
    return this;
  }
  ...
  public KickGroupMemberResp setId2Result(List<Id2Result> id2Result) {
    this.id2Result = id2Result;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof KickGroupMemberResp)
      return this.equals((KickGroupMemberResp)that);
    return false;
  }

  public boolean equals(KickGroupMemberResp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(KickGroupMemberResp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("KickGroupMemberResp(");
    boolean first = true;
  ...
  private static class KickGroupMemberRespStandardSchemeFactory implements SchemeFactory {
    public KickGroupMemberRespStandardScheme getScheme() {
      return new KickGroupMemberRespStandardScheme();
    }
  }

  private static class KickGroupMemberRespStandardScheme extends StandardScheme<KickGroupMemberResp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, KickGroupMemberResp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.id2Result = new ArrayList<Id2Result>(_list460.size);
                Id2Result _elem461;
                for (int _i462 = 0; _i462 < _list460.size; ++_i462)
                {
                  _elem461 = new Id2Result();
                  _elem461.read(iprot);
                  struct.id2Result.add(_elem461);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, KickGroupMemberResp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.id2Result != null) {
        oprot.writeFieldBegin(ID2_RESULT_FIELD_DESC);
        {
          ...
          for (Id2Result _iter463 : struct.id2Result)
          {
  ...
  private static class KickGroupMemberRespTupleSchemeFactory implements SchemeFactory {
    public KickGroupMemberRespTupleScheme getScheme() {
      return new KickGroupMemberRespTupleScheme();
    }
  }

  private static class KickGroupMemberRespTupleScheme extends TupleScheme<KickGroupMemberResp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, KickGroupMemberResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetId2Result()) {
        {
          ...
          for (Id2Result _iter464 : struct.id2Result)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, KickGroupMemberResp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.id2Result = new ArrayList<Id2Result>(_list465.size);
          Id2Result _elem466;
          for (int _i467 = 0; _i467 < _list465.size; ++_i467)
          {
            _elem466 = new Id2Result();
            _elem466.read(iprot);
            struct.id2Result.add(_elem466);
          }
        }
        struct.setId2ResultIsSet(true);
      }
