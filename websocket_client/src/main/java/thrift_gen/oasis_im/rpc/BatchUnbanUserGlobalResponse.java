...
public class BatchUnbanUserGlobalResponse implements org.apache.thrift.TBase<BatchUnbanUserGlobalResponse, BatchUnbanUserGlobalResponse._Fields>, java.io.Serializable, Cloneable, Comparable<BatchUnbanUserGlobalResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BatchUnbanUserGlobalResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new BatchUnbanUserGlobalResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BatchUnbanUserGlobalResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BatchUnbanUserGlobalResponse.class, metaDataMap);
  }

  public BatchUnbanUserGlobalResponse() {
  }
   ...
   */
  public BatchUnbanUserGlobalResponse(BatchUnbanUserGlobalResponse other) {
    if (other.isSetBase()) {
  ...
  public BatchUnbanUserGlobalResponse deepCopy() {
    return new BatchUnbanUserGlobalResponse(this);
  }
  ...
  public BatchUnbanUserGlobalResponse setBase(BaseResp base) {
    this.base = base;
    return this;
  }
  ...
  public BatchUnbanUserGlobalResponse setFailedUidList(List<String> failedUidList) {
    this.failedUidList = failedUidList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BatchUnbanUserGlobalResponse)
      return this.equals((BatchUnbanUserGlobalResponse)that);
    return false;
  }

  public boolean equals(BatchUnbanUserGlobalResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BatchUnbanUserGlobalResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BatchUnbanUserGlobalResponse(");
    boolean first = true;
  ...
  private static class BatchUnbanUserGlobalResponseStandardSchemeFactory implements SchemeFactory {
    public BatchUnbanUserGlobalResponseStandardScheme getScheme() {
      return new BatchUnbanUserGlobalResponseStandardScheme();
    }
  }

  private static class BatchUnbanUserGlobalResponseStandardScheme extends StandardScheme<BatchUnbanUserGlobalResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BatchUnbanUserGlobalResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.failedUidList = new ArrayList<String>(_list94.size);
                String _elem95;
                for (int _i96 = 0; _i96 < _list94.size; ++_i96)
                {
                  _elem95 = iprot.readString();
                  struct.failedUidList.add(_elem95);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BatchUnbanUserGlobalResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.failedUidList != null) {
        oprot.writeFieldBegin(FAILED_UID_LIST_FIELD_DESC);
        {
          ...
          for (String _iter97 : struct.failedUidList)
          {
  ...
  private static class BatchUnbanUserGlobalResponseTupleSchemeFactory implements SchemeFactory {
    public BatchUnbanUserGlobalResponseTupleScheme getScheme() {
      return new BatchUnbanUserGlobalResponseTupleScheme();
    }
  }

  private static class BatchUnbanUserGlobalResponseTupleScheme extends TupleScheme<BatchUnbanUserGlobalResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BatchUnbanUserGlobalResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetFailedUidList()) {
        {
          ...
          for (String _iter98 : struct.failedUidList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BatchUnbanUserGlobalResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.failedUidList = new ArrayList<String>(_list99.size);
          String _elem100;
          for (int _i101 = 0; _i101 < _list99.size; ++_i101)
          {
            _elem100 = iprot.readString();
            struct.failedUidList.add(_elem100);
          }
        }
        struct.setFailedUidListIsSet(true);
      }
