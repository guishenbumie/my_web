...
public class GetGroupAllMemberResp implements org.apache.thrift.TBase<GetGroupAllMemberResp, GetGroupAllMemberResp._Fields>, java.io.Serializable, Cloneable, Comparable<GetGroupAllMemberResp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetGroupAllMemberResp");
  ...
  static {
    schemes.put(StandardScheme.class, new GetGroupAllMemberRespStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetGroupAllMemberRespTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetGroupAllMemberResp.class, metaDataMap);
  }

  public GetGroupAllMemberResp() {
  }
   ...
   */
  public GetGroupAllMemberResp(GetGroupAllMemberResp other) {
    if (other.isSetBase()) {
  ...
  public GetGroupAllMemberResp deepCopy() {
    return new GetGroupAllMemberResp(this);
  }
  ...
  public GetGroupAllMemberResp setBase(BaseResp base) {
    this.base = base;
    return this;
  }
  ...
  public GetGroupAllMemberResp setMemberList(List<GroupMemberFullInfo> memberList) {
    this.memberList = memberList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetGroupAllMemberResp)
      return this.equals((GetGroupAllMemberResp)that);
    return false;
  }

  public boolean equals(GetGroupAllMemberResp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetGroupAllMemberResp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetGroupAllMemberResp(");
    boolean first = true;
  ...
  private static class GetGroupAllMemberRespStandardSchemeFactory implements SchemeFactory {
    public GetGroupAllMemberRespStandardScheme getScheme() {
      return new GetGroupAllMemberRespStandardScheme();
    }
  }

  private static class GetGroupAllMemberRespStandardScheme extends StandardScheme<GetGroupAllMemberResp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetGroupAllMemberResp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.memberList = new ArrayList<GroupMemberFullInfo>(_list502.size);
                GroupMemberFullInfo _elem503;
                for (int _i504 = 0; _i504 < _list502.size; ++_i504)
                {
                  _elem503 = new GroupMemberFullInfo();
                  _elem503.read(iprot);
                  struct.memberList.add(_elem503);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetGroupAllMemberResp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.memberList != null) {
        oprot.writeFieldBegin(MEMBER_LIST_FIELD_DESC);
        {
          ...
          for (GroupMemberFullInfo _iter505 : struct.memberList)
          {
  ...
  private static class GetGroupAllMemberRespTupleSchemeFactory implements SchemeFactory {
    public GetGroupAllMemberRespTupleScheme getScheme() {
      return new GetGroupAllMemberRespTupleScheme();
    }
  }

  private static class GetGroupAllMemberRespTupleScheme extends TupleScheme<GetGroupAllMemberResp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetGroupAllMemberResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetMemberList()) {
        {
          ...
          for (GroupMemberFullInfo _iter506 : struct.memberList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetGroupAllMemberResp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.memberList = new ArrayList<GroupMemberFullInfo>(_list507.size);
          GroupMemberFullInfo _elem508;
          for (int _i509 = 0; _i509 < _list507.size; ++_i509)
          {
            _elem508 = new GroupMemberFullInfo();
            _elem508.read(iprot);
            struct.memberList.add(_elem508);
          }
        }
        struct.setMemberListIsSet(true);
      }
