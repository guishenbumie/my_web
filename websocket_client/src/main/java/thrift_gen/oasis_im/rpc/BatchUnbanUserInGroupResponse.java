...
public class BatchUnbanUserInGroupResponse implements org.apache.thrift.TBase<BatchUnbanUserInGroupResponse, BatchUnbanUserInGroupResponse._Fields>, java.io.Serializable, Cloneable, Comparable<BatchUnbanUserInGroupResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BatchUnbanUserInGroupResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new BatchUnbanUserInGroupResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BatchUnbanUserInGroupResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BatchUnbanUserInGroupResponse.class, metaDataMap);
  }

  public BatchUnbanUserInGroupResponse() {
  }
   ...
   */
  public BatchUnbanUserInGroupResponse(BatchUnbanUserInGroupResponse other) {
    if (other.isSetBase()) {
  ...
  public BatchUnbanUserInGroupResponse deepCopy() {
    return new BatchUnbanUserInGroupResponse(this);
  }
  ...
  public BatchUnbanUserInGroupResponse setBase(BaseResp base) {
    this.base = base;
    return this;
  }
  ...
  public BatchUnbanUserInGroupResponse setFailedUidList(List<String> failedUidList) {
    this.failedUidList = failedUidList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BatchUnbanUserInGroupResponse)
      return this.equals((BatchUnbanUserInGroupResponse)that);
    return false;
  }

  public boolean equals(BatchUnbanUserInGroupResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BatchUnbanUserInGroupResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BatchUnbanUserInGroupResponse(");
    boolean first = true;
  ...
  private static class BatchUnbanUserInGroupResponseStandardSchemeFactory implements SchemeFactory {
    public BatchUnbanUserInGroupResponseStandardScheme getScheme() {
      return new BatchUnbanUserInGroupResponseStandardScheme();
    }
  }

  private static class BatchUnbanUserInGroupResponseStandardScheme extends StandardScheme<BatchUnbanUserInGroupResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BatchUnbanUserInGroupResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.failedUidList = new ArrayList<String>(_list146.size);
                String _elem147;
                for (int _i148 = 0; _i148 < _list146.size; ++_i148)
                {
                  _elem147 = iprot.readString();
                  struct.failedUidList.add(_elem147);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BatchUnbanUserInGroupResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.failedUidList != null) {
        oprot.writeFieldBegin(FAILED_UID_LIST_FIELD_DESC);
        {
          ...
          for (String _iter149 : struct.failedUidList)
          {
  ...
  private static class BatchUnbanUserInGroupResponseTupleSchemeFactory implements SchemeFactory {
    public BatchUnbanUserInGroupResponseTupleScheme getScheme() {
      return new BatchUnbanUserInGroupResponseTupleScheme();
    }
  }

  private static class BatchUnbanUserInGroupResponseTupleScheme extends TupleScheme<BatchUnbanUserInGroupResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BatchUnbanUserInGroupResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetFailedUidList()) {
        {
          ...
          for (String _iter150 : struct.failedUidList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BatchUnbanUserInGroupResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.failedUidList = new ArrayList<String>(_list151.size);
          String _elem152;
          for (int _i153 = 0; _i153 < _list151.size; ++_i153)
          {
            _elem152 = iprot.readString();
            struct.failedUidList.add(_elem152);
          }
        }
        struct.setFailedUidListIsSet(true);
      }
