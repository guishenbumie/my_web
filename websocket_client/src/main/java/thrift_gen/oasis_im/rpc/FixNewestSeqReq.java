...
public class FixNewestSeqReq implements org.apache.thrift.TBase<FixNewestSeqReq, FixNewestSeqReq._Fields>, java.io.Serializable, Cloneable, Comparable<FixNewestSeqReq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FixNewestSeqReq");
  ...
  static {
    schemes.put(StandardScheme.class, new FixNewestSeqReqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FixNewestSeqReqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FixNewestSeqReq.class, metaDataMap);
  }

  public FixNewestSeqReq() {
  }
   ...
   */
  public FixNewestSeqReq(FixNewestSeqReq other) {
    if (other.isSetToken()) {
  ...
  public FixNewestSeqReq deepCopy() {
    return new FixNewestSeqReq(this);
  }
  ...
  public FixNewestSeqReq setToken(String token) {
    this.token = token;
    return this;
  }
   ...
   * @see SESSION_TYPE
   */
  public FixNewestSeqReq setSessionType(SESSION_TYPE sessionType) {
    this.sessionType = sessionType;
    return this;
  }
  ...
  public FixNewestSeqReq setSessionKey(String sessionKey) {
    this.sessionKey = sessionKey;
    return this;
  }
  ...
  public FixNewestSeqReq setBase(thrift_gen.base.Base Base) {
    this.Base = Base;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FixNewestSeqReq)
      return this.equals((FixNewestSeqReq)that);
    return false;
  }

  public boolean equals(FixNewestSeqReq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FixNewestSeqReq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FixNewestSeqReq(");
    boolean first = true;
  ...
  private static class FixNewestSeqReqStandardSchemeFactory implements SchemeFactory {
    public FixNewestSeqReqStandardScheme getScheme() {
      return new FixNewestSeqReqStandardScheme();
    }
  }

  private static class FixNewestSeqReqStandardScheme extends StandardScheme<FixNewestSeqReq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FixNewestSeqReq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FixNewestSeqReq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FixNewestSeqReqTupleSchemeFactory implements SchemeFactory {
    public FixNewestSeqReqTupleScheme getScheme() {
      return new FixNewestSeqReqTupleScheme();
    }
  }

  private static class FixNewestSeqReqTupleScheme extends TupleScheme<FixNewestSeqReq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FixNewestSeqReq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FixNewestSeqReq struct) throws org.apache.thrift.TException {
