...
public class InviteUserToGroup implements org.apache.thrift.TBase<InviteUserToGroup, InviteUserToGroup._Fields>, java.io.Serializable, Cloneable, Comparable<InviteUserToGroup> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("InviteUserToGroup");
  ...
  static {
    schemes.put(StandardScheme.class, new InviteUserToGroupStandardSchemeFactory());
    schemes.put(TupleScheme.class, new InviteUserToGroupTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(InviteUserToGroup.class, metaDataMap);
  }
   ...
   */
  public InviteUserToGroup(InviteUserToGroup other) {
  ...
  public InviteUserToGroup deepCopy() {
    return new InviteUserToGroup(this);
  }
  ...
  public InviteUserToGroup setGroupID(String groupID) {
    this.groupID = groupID;
    return this;
  }
  ...
  public InviteUserToGroup setReason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public InviteUserToGroup setUidList(List<String> uidList) {
    this.uidList = uidList;
    return this;
  }
  ...
  public InviteUserToGroup setServerID(String serverID) {
    this.serverID = serverID;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof InviteUserToGroup)
      return this.equals((InviteUserToGroup)that);
    return false;
  }

  public boolean equals(InviteUserToGroup that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(InviteUserToGroup other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("InviteUserToGroup(");
    boolean first = true;
  ...
  private static class InviteUserToGroupStandardSchemeFactory implements SchemeFactory {
    public InviteUserToGroupStandardScheme getScheme() {
      return new InviteUserToGroupStandardScheme();
    }
  }

  private static class InviteUserToGroupStandardScheme extends StandardScheme<InviteUserToGroup> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, InviteUserToGroup struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uidList = new ArrayList<String>(_list486.size);
                String _elem487;
                for (int _i488 = 0; _i488 < _list486.size; ++_i488)
                {
                  _elem487 = iprot.readString();
                  struct.uidList.add(_elem487);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InviteUserToGroup struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.uidList != null) {
        oprot.writeFieldBegin(UID_LIST_FIELD_DESC);
        {
          ...
          for (String _iter489 : struct.uidList)
          {
  ...
  private static class InviteUserToGroupTupleSchemeFactory implements SchemeFactory {
    public InviteUserToGroupTupleScheme getScheme() {
      return new InviteUserToGroupTupleScheme();
    }
  }

  private static class InviteUserToGroupTupleScheme extends TupleScheme<InviteUserToGroup> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, InviteUserToGroup struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUidList()) {
        {
          ...
          for (String _iter490 : struct.uidList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, InviteUserToGroup struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.uidList = new ArrayList<String>(_list491.size);
          String _elem492;
          for (int _i493 = 0; _i493 < _list491.size; ++_i493)
          {
            _elem492 = iprot.readString();
            struct.uidList.add(_elem492);
          }
        }
        struct.setUidListIsSet(true);
      }
