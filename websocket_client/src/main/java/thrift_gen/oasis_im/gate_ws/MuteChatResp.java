...
public class MuteChatResp implements org.apache.thrift.TBase<MuteChatResp, MuteChatResp._Fields>, java.io.Serializable, Cloneable, Comparable<MuteChatResp> {
  ...
  public MuteChatResp setMsgIncr(int msgIncr) {
    this.msgIncr = msgIncr;
    setMsgIncrIsSet(true);
    return this;
  }
  ...
  public MuteChatResp setErrCode(int errCode) {
    this.errCode = errCode;
    setErrCodeIsSet(true);
    return this;
  }
  ...
  public MuteChatResp setErrMsg(String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
   ...
   * @see thrift_gen.oasis_im.rpc.SESSION_TYPE
   */
  public MuteChatResp setSessionType(thrift_gen.oasis_im.rpc.SESSION_TYPE sessionType) {
    this.sessionType = sessionType;
    return this;
  }
