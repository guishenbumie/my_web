...
public class AddBlacklistResp implements org.apache.thrift.TBase<AddBlacklistResp, AddBlacklistResp._Fields>, java.io.Serializable, Cloneable, Comparable<AddBlacklistResp> {
  ...
  private static final org.apache.thrift.protocol.TField BLOCK_USER_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("blockUserInfo", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  ...
  public thrift_gen.oasis_im.rpc.UserInfo blockUserInfo; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    BLOCK_USER_INFO((short)4, "blockUserInfo");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // ERR_MSG
          return ERR_MSG;
        case 4: // BLOCK_USER_INFO
          return BLOCK_USER_INFO;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.BLOCK_USER_INFO, new org.apache.thrift.meta_data.FieldMetaData("blockUserInfo", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public AddBlacklistResp(
    ...
    int errCode,
    String errMsg,
    thrift_gen.oasis_im.rpc.UserInfo blockUserInfo)
  {
    this();
  ...
  public AddBlacklistResp(AddBlacklistResp other) {
    ...
    if (other.isSetBlockUserInfo()) {
      this.blockUserInfo = new thrift_gen.oasis_im.rpc.UserInfo(other.blockUserInfo);
    }
  }
  ...
  public AddBlacklistResp setMsgIncr(int msgIncr) {
    this.msgIncr = msgIncr;
    setMsgIncrIsSet(true);
    return this;
  }
  ...
  public AddBlacklistResp setErrCode(int errCode) {
    this.errCode = errCode;
    setErrCodeIsSet(true);
    return this;
  }
  ...
  public AddBlacklistResp setErrMsg(String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public thrift_gen.oasis_im.rpc.UserInfo getBlockUserInfo() {
    return this.blockUserInfo;
  }

  public AddBlacklistResp setBlockUserInfo(thrift_gen.oasis_im.rpc.UserInfo blockUserInfo) {
    this.blockUserInfo = blockUserInfo;
    return this;
  }

  public void unsetBlockUserInfo() {
    this.blockUserInfo = null;
  }

  /** Returns true if field blockUserInfo is set (has been assigned a value) and false otherwise */
  public boolean isSetBlockUserInfo() {
    return this.blockUserInfo != null;
  }

  public void setBlockUserInfoIsSet(boolean value) {
    if (!value) {
      this.blockUserInfo = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BLOCK_USER_INFO:
      if (value == null) {
        ...
        setBlockUserInfo((thrift_gen.oasis_im.rpc.UserInfo)value);
      }
      break;
  ...
  public boolean equals(AddBlacklistResp that) {
    ...
    boolean this_present_blockUserInfo = true && this.isSetBlockUserInfo();
    boolean that_present_blockUserInfo = true && that.isSetBlockUserInfo();
    if (this_present_blockUserInfo || that_present_blockUserInfo) {
      if (!(this_present_blockUserInfo && that_present_blockUserInfo))
        return false;
      if (!this.blockUserInfo.equals(that.blockUserInfo))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_blockUserInfo = true && (isSetBlockUserInfo());
    list.add(present_blockUserInfo);
    if (present_blockUserInfo)
      list.add(blockUserInfo);
  ...
  public int compareTo(AddBlacklistResp other) {
    ...
    lastComparison = Boolean.valueOf(isSetBlockUserInfo()).compareTo(other.isSetBlockUserInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBlockUserInfo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.blockUserInfo, other.blockUserInfo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("blockUserInfo:");
    if (this.blockUserInfo == null) {
      sb.append("null");
    } else {
      sb.append(this.blockUserInfo);
    }
    first = false;
    sb.append(")");
    return sb.toString();
  ...
  private static class AddBlacklistRespStandardScheme extends StandardScheme<AddBlacklistResp> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // BLOCK_USER_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.blockUserInfo = new thrift_gen.oasis_im.rpc.UserInfo();
              struct.blockUserInfo.read(iprot);
              struct.setBlockUserInfoIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddBlacklistResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.blockUserInfo != null) {
        oprot.writeFieldBegin(BLOCK_USER_INFO_FIELD_DESC);
        struct.blockUserInfo.write(oprot);
        oprot.writeFieldEnd();
      }
