...
public class AddGroupMemberResp implements org.apache.thrift.TBase<AddGroupMemberResp, AddGroupMemberResp._Fields>, java.io.Serializable, Cloneable, Comparable<AddGroupMemberResp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddGroupMemberResp");
  ...
  static {
    schemes.put(StandardScheme.class, new AddGroupMemberRespStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddGroupMemberRespTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddGroupMemberResp.class, metaDataMap);
  }
   ...
   */
  public AddGroupMemberResp(AddGroupMemberResp other) {
  ...
  public AddGroupMemberResp deepCopy() {
  ...
  public AddGroupMemberResp setMsgIncr(int msgIncr) {
    this.msgIncr = msgIncr;
    setMsgIncrIsSet(true);
    return this;
  }
  ...
  public AddGroupMemberResp setErrCode(int errCode) {
    this.errCode = errCode;
    setErrCodeIsSet(true);
    return this;
  }
  ...
  public AddGroupMemberResp setErrMsg(String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public AddGroupMemberResp setResult(List<thrift_gen.oasis_im.rpc.Id2Result> result) {
    this.result = result;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddGroupMemberResp)
      return this.equals((AddGroupMemberResp)that);
    return false;
  }

  public boolean equals(AddGroupMemberResp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddGroupMemberResp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddGroupMemberResp(");
    boolean first = true;
  ...
  private static class AddGroupMemberRespStandardSchemeFactory implements SchemeFactory {
    public AddGroupMemberRespStandardScheme getScheme() {
      return new AddGroupMemberRespStandardScheme();
    }
  }

  private static class AddGroupMemberRespStandardScheme extends StandardScheme<AddGroupMemberResp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddGroupMemberResp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result = new ArrayList<thrift_gen.oasis_im.rpc.Id2Result>(_list128.size);
                thrift_gen.oasis_im.rpc.Id2Result _elem129;
                for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                {
                  _elem129 = new thrift_gen.oasis_im.rpc.Id2Result();
                  _elem129.read(iprot);
                  struct.result.add(_elem129);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddGroupMemberResp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.result != null) {
        oprot.writeFieldBegin(RESULT_FIELD_DESC);
        {
          ...
          for (thrift_gen.oasis_im.rpc.Id2Result _iter131 : struct.result)
          {
  ...
  private static class AddGroupMemberRespTupleSchemeFactory implements SchemeFactory {
    public AddGroupMemberRespTupleScheme getScheme() {
      return new AddGroupMemberRespTupleScheme();
    }
  }

  private static class AddGroupMemberRespTupleScheme extends TupleScheme<AddGroupMemberResp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddGroupMemberResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResult()) {
        {
          ...
          for (thrift_gen.oasis_im.rpc.Id2Result _iter132 : struct.result)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddGroupMemberResp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.result = new ArrayList<thrift_gen.oasis_im.rpc.Id2Result>(_list133.size);
          thrift_gen.oasis_im.rpc.Id2Result _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = new thrift_gen.oasis_im.rpc.Id2Result();
            _elem134.read(iprot);
            struct.result.add(_elem134);
          }
        }
        struct.setResultIsSet(true);
      }
