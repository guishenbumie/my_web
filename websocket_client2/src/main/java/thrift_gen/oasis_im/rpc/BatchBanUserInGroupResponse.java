...
public class BatchBanUserInGroupResponse implements org.apache.thrift.TBase<BatchBanUserInGroupResponse, BatchBanUserInGroupResponse._Fields>, java.io.Serializable, Cloneable, Comparable<BatchBanUserInGroupResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BatchBanUserInGroupResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new BatchBanUserInGroupResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BatchBanUserInGroupResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BatchBanUserInGroupResponse.class, metaDataMap);
  }

  public BatchBanUserInGroupResponse() {
  }
   ...
   */
  public BatchBanUserInGroupResponse(BatchBanUserInGroupResponse other) {
    if (other.isSetBase()) {
  ...
  public BatchBanUserInGroupResponse deepCopy() {
    return new BatchBanUserInGroupResponse(this);
  }
  ...
  public BatchBanUserInGroupResponse setBase(BaseResp base) {
    this.base = base;
    return this;
  }
  ...
  public BatchBanUserInGroupResponse setFailedUidList(List<String> failedUidList) {
    this.failedUidList = failedUidList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BatchBanUserInGroupResponse)
      return this.equals((BatchBanUserInGroupResponse)that);
    return false;
  }

  public boolean equals(BatchBanUserInGroupResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BatchBanUserInGroupResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BatchBanUserInGroupResponse(");
    boolean first = true;
  ...
  private static class BatchBanUserInGroupResponseStandardSchemeFactory implements SchemeFactory {
    public BatchBanUserInGroupResponseStandardScheme getScheme() {
      return new BatchBanUserInGroupResponseStandardScheme();
    }
  }

  private static class BatchBanUserInGroupResponseStandardScheme extends StandardScheme<BatchBanUserInGroupResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BatchBanUserInGroupResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.failedUidList = new ArrayList<String>(_list130.size);
                String _elem131;
                for (int _i132 = 0; _i132 < _list130.size; ++_i132)
                {
                  _elem131 = iprot.readString();
                  struct.failedUidList.add(_elem131);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BatchBanUserInGroupResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.failedUidList != null) {
        oprot.writeFieldBegin(FAILED_UID_LIST_FIELD_DESC);
        {
          ...
          for (String _iter133 : struct.failedUidList)
          {
  ...
  private static class BatchBanUserInGroupResponseTupleSchemeFactory implements SchemeFactory {
    public BatchBanUserInGroupResponseTupleScheme getScheme() {
      return new BatchBanUserInGroupResponseTupleScheme();
    }
  }

  private static class BatchBanUserInGroupResponseTupleScheme extends TupleScheme<BatchBanUserInGroupResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BatchBanUserInGroupResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetFailedUidList()) {
        {
          ...
          for (String _iter134 : struct.failedUidList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BatchBanUserInGroupResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.failedUidList = new ArrayList<String>(_list135.size);
          String _elem136;
          for (int _i137 = 0; _i137 < _list135.size; ++_i137)
          {
            _elem136 = iprot.readString();
            struct.failedUidList.add(_elem136);
          }
        }
        struct.setFailedUidListIsSet(true);
      }
