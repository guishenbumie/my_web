...
public class ImmigrateUserResp implements org.apache.thrift.TBase<ImmigrateUserResp, ImmigrateUserResp._Fields>, java.io.Serializable, Cloneable, Comparable<ImmigrateUserResp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ImmigrateUserResp");
  ...
  static {
    schemes.put(StandardScheme.class, new ImmigrateUserRespStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ImmigrateUserRespTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ImmigrateUserResp.class, metaDataMap);
  }

  public ImmigrateUserResp() {
  }
   ...
   */
  public ImmigrateUserResp(ImmigrateUserResp other) {
    if (other.isSetBase()) {
  ...
  public ImmigrateUserResp deepCopy() {
    return new ImmigrateUserResp(this);
  }
  ...
  public ImmigrateUserResp setBase(BaseResp base) {
    this.base = base;
    return this;
  }
  ...
  public ImmigrateUserResp setUids(List<String> uids) {
    this.uids = uids;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ImmigrateUserResp)
      return this.equals((ImmigrateUserResp)that);
    return false;
  }

  public boolean equals(ImmigrateUserResp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ImmigrateUserResp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ImmigrateUserResp(");
    boolean first = true;
  ...
  private static class ImmigrateUserRespStandardSchemeFactory implements SchemeFactory {
    public ImmigrateUserRespStandardScheme getScheme() {
      return new ImmigrateUserRespStandardScheme();
    }
  }

  private static class ImmigrateUserRespStandardScheme extends StandardScheme<ImmigrateUserResp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ImmigrateUserResp struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uids = new ArrayList<String>(_list188.size);
                String _elem189;
                for (int _i190 = 0; _i190 < _list188.size; ++_i190)
                {
                  _elem189 = iprot.readString();
                  struct.uids.add(_elem189);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ImmigrateUserResp struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.uids != null) {
        oprot.writeFieldBegin(UIDS_FIELD_DESC);
        {
          ...
          for (String _iter191 : struct.uids)
          {
  ...
  private static class ImmigrateUserRespTupleSchemeFactory implements SchemeFactory {
    public ImmigrateUserRespTupleScheme getScheme() {
      return new ImmigrateUserRespTupleScheme();
    }
  }

  private static class ImmigrateUserRespTupleScheme extends TupleScheme<ImmigrateUserResp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ImmigrateUserResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUids()) {
        {
          ...
          for (String _iter192 : struct.uids)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ImmigrateUserResp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.uids = new ArrayList<String>(_list193.size);
          String _elem194;
          for (int _i195 = 0; _i195 < _list193.size; ++_i195)
          {
            _elem194 = iprot.readString();
            struct.uids.add(_elem194);
          }
        }
        struct.setUidsIsSet(true);
      }
