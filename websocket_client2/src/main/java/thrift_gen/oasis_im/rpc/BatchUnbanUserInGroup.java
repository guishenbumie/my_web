...
public class BatchUnbanUserInGroup implements org.apache.thrift.TBase<BatchUnbanUserInGroup, BatchUnbanUserInGroup._Fields>, java.io.Serializable, Cloneable, Comparable<BatchUnbanUserInGroup> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BatchUnbanUserInGroup");
  ...
  static {
    schemes.put(StandardScheme.class, new BatchUnbanUserInGroupStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BatchUnbanUserInGroupTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BatchUnbanUserInGroup.class, metaDataMap);
  }

  public BatchUnbanUserInGroup() {
  }
   ...
   */
  public BatchUnbanUserInGroup(BatchUnbanUserInGroup other) {
  ...
  public BatchUnbanUserInGroup deepCopy() {
    return new BatchUnbanUserInGroup(this);
  }
  ...
  public BatchUnbanUserInGroup setGroupID(String groupID) {
    this.groupID = groupID;
    return this;
  }
  ...
  public BatchUnbanUserInGroup setUidList(List<String> uidList) {
    this.uidList = uidList;
    return this;
  }
  ...
  public BatchUnbanUserInGroup setServerID(String serverID) {
    this.serverID = serverID;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BatchUnbanUserInGroup)
      return this.equals((BatchUnbanUserInGroup)that);
    return false;
  }

  public boolean equals(BatchUnbanUserInGroup that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BatchUnbanUserInGroup other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BatchUnbanUserInGroup(");
    boolean first = true;
  ...
  private static class BatchUnbanUserInGroupStandardSchemeFactory implements SchemeFactory {
    public BatchUnbanUserInGroupStandardScheme getScheme() {
      return new BatchUnbanUserInGroupStandardScheme();
    }
  }

  private static class BatchUnbanUserInGroupStandardScheme extends StandardScheme<BatchUnbanUserInGroup> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BatchUnbanUserInGroup struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uidList = new ArrayList<String>(_list138.size);
                String _elem139;
                for (int _i140 = 0; _i140 < _list138.size; ++_i140)
                {
                  _elem139 = iprot.readString();
                  struct.uidList.add(_elem139);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BatchUnbanUserInGroup struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.uidList != null) {
        oprot.writeFieldBegin(UID_LIST_FIELD_DESC);
        {
          ...
          for (String _iter141 : struct.uidList)
          {
  ...
  private static class BatchUnbanUserInGroupTupleSchemeFactory implements SchemeFactory {
    public BatchUnbanUserInGroupTupleScheme getScheme() {
      return new BatchUnbanUserInGroupTupleScheme();
    }
  }

  private static class BatchUnbanUserInGroupTupleScheme extends TupleScheme<BatchUnbanUserInGroup> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BatchUnbanUserInGroup struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUidList()) {
        {
          ...
          for (String _iter142 : struct.uidList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BatchUnbanUserInGroup struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.uidList = new ArrayList<String>(_list143.size);
          String _elem144;
          for (int _i145 = 0; _i145 < _list143.size; ++_i145)
          {
            _elem144 = iprot.readString();
            struct.uidList.add(_elem144);
          }
        }
        struct.setUidListIsSet(true);
      }
