...
public class AddGroupMemberBatch implements org.apache.thrift.TBase<AddGroupMemberBatch, AddGroupMemberBatch._Fields>, java.io.Serializable, Cloneable, Comparable<AddGroupMemberBatch> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AddGroupMemberBatch");
  ...
  static {
    schemes.put(StandardScheme.class, new AddGroupMemberBatchStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AddGroupMemberBatchTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AddGroupMemberBatch.class, metaDataMap);
  }

  public AddGroupMemberBatch() {
  }
   ...
   */
  public AddGroupMemberBatch(AddGroupMemberBatch other) {
  ...
  public AddGroupMemberBatch deepCopy() {
    return new AddGroupMemberBatch(this);
  }
  ...
  public AddGroupMemberBatch setGroupID(String groupID) {
    this.groupID = groupID;
    return this;
  }
  ...
  public AddGroupMemberBatch setReason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public AddGroupMemberBatch setUidList(List<String> uidList) {
    this.uidList = uidList;
    return this;
  }
  ...
  public AddGroupMemberBatch setServerID(String serverID) {
    this.serverID = serverID;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AddGroupMemberBatch)
      return this.equals((AddGroupMemberBatch)that);
    return false;
  }

  public boolean equals(AddGroupMemberBatch that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AddGroupMemberBatch other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AddGroupMemberBatch(");
    boolean first = true;
  ...
  private static class AddGroupMemberBatchStandardSchemeFactory implements SchemeFactory {
    public AddGroupMemberBatchStandardScheme getScheme() {
      return new AddGroupMemberBatchStandardScheme();
    }
  }

  private static class AddGroupMemberBatchStandardScheme extends StandardScheme<AddGroupMemberBatch> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AddGroupMemberBatch struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.uidList = new ArrayList<String>(_list380.size);
                String _elem381;
                for (int _i382 = 0; _i382 < _list380.size; ++_i382)
                {
                  _elem381 = iprot.readString();
                  struct.uidList.add(_elem381);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AddGroupMemberBatch struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.uidList != null) {
        oprot.writeFieldBegin(UID_LIST_FIELD_DESC);
        {
          ...
          for (String _iter383 : struct.uidList)
          {
  ...
  private static class AddGroupMemberBatchTupleSchemeFactory implements SchemeFactory {
    public AddGroupMemberBatchTupleScheme getScheme() {
      return new AddGroupMemberBatchTupleScheme();
    }
  }

  private static class AddGroupMemberBatchTupleScheme extends TupleScheme<AddGroupMemberBatch> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AddGroupMemberBatch struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetUidList()) {
        {
          ...
          for (String _iter384 : struct.uidList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AddGroupMemberBatch struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.uidList = new ArrayList<String>(_list385.size);
          String _elem386;
          for (int _i387 = 0; _i387 < _list385.size; ++_i387)
          {
            _elem386 = iprot.readString();
            struct.uidList.add(_elem386);
          }
        }
        struct.setUidListIsSet(true);
      }
