...
public class CloseChatReq implements org.apache.thrift.TBase<CloseChatReq, CloseChatReq._Fields>, java.io.Serializable, Cloneable, Comparable<CloseChatReq> {
  ...
  public CloseChatReq setToken(String token) {
    this.token = token;
    return this;
  }
   ...
   * @see SESSION_TYPE
   */
  public CloseChatReq setSessionType(SESSION_TYPE sessionType) {
    this.sessionType = sessionType;
    return this;
  }
  ...
  public CloseChatReq setBase(thrift_gen.base.Base Base) {
    this.Base = Base;
    return this;
  }
