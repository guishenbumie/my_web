...
public class CheckBannedUser implements org.apache.thrift.TBase<CheckBannedUser, CheckBannedUser._Fields>, java.io.Serializable, Cloneable, Comparable<CheckBannedUser> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CheckBannedUser");
  ...
  static {
    schemes.put(StandardScheme.class, new CheckBannedUserStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CheckBannedUserTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CheckBannedUser.class, metaDataMap);
  }

  public CheckBannedUser() {
  }
   ...
   */
  public CheckBannedUser(CheckBannedUser other) {
    if (other.isSetUid()) {
      this.uid = other.uid;
    }
  ...
  public CheckBannedUser deepCopy() {
    return new CheckBannedUser(this);
  }
  ...
  public CheckBannedUser setUid(String uid) {
    this.uid = uid;
    return this;
  }
  ...
  public CheckBannedUser setBannedUid(String bannedUid) {
    this.bannedUid = bannedUid;
    return this;
  }
  ...
  public CheckBannedUser setServerID(String serverID) {
    this.serverID = serverID;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CheckBannedUser)
      return this.equals((CheckBannedUser)that);
    return false;
  }

  public boolean equals(CheckBannedUser that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CheckBannedUser other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CheckBannedUser(");
    boolean first = true;
  ...
  private static class CheckBannedUserStandardSchemeFactory implements SchemeFactory {
    public CheckBannedUserStandardScheme getScheme() {
      return new CheckBannedUserStandardScheme();
    }
  }

  private static class CheckBannedUserStandardScheme extends StandardScheme<CheckBannedUser> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CheckBannedUser struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CheckBannedUser struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CheckBannedUserTupleSchemeFactory implements SchemeFactory {
    public CheckBannedUserTupleScheme getScheme() {
      return new CheckBannedUserTupleScheme();
    }
  }

  private static class CheckBannedUserTupleScheme extends TupleScheme<CheckBannedUser> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CheckBannedUser struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CheckBannedUser struct) throws org.apache.thrift.TException {
