...
public class GetNewSeq implements org.apache.thrift.TBase<GetNewSeq, GetNewSeq._Fields>, java.io.Serializable, Cloneable, Comparable<GetNewSeq> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetNewSeq");
  ...
  static {
    schemes.put(StandardScheme.class, new GetNewSeqStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetNewSeqTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetNewSeq.class, metaDataMap);
  }
   ...
   */
  public GetNewSeq(GetNewSeq other) {
    if (other.isSetUid()) {
      this.uid = other.uid;
    }
  ...
  public GetNewSeq deepCopy() {
    return new GetNewSeq(this);
  }
  ...
  public GetNewSeq setUid(String uid) {
    this.uid = uid;
    return this;
  }
   ...
   * @see SESSION_TYPE
   */
  public GetNewSeq setSessionType(SESSION_TYPE sessionType) {
    this.sessionType = sessionType;
    return this;
  }
  ...
  public GetNewSeq setSessionKey(String sessionKey) {
    this.sessionKey = sessionKey;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetNewSeq)
      return this.equals((GetNewSeq)that);
    return false;
  }

  public boolean equals(GetNewSeq that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetNewSeq other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetNewSeq(");
    boolean first = true;
  ...
  private static class GetNewSeqStandardSchemeFactory implements SchemeFactory {
    public GetNewSeqStandardScheme getScheme() {
      return new GetNewSeqStandardScheme();
    }
  }

  private static class GetNewSeqStandardScheme extends StandardScheme<GetNewSeq> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetNewSeq struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetNewSeq struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetNewSeqTupleSchemeFactory implements SchemeFactory {
    public GetNewSeqTupleScheme getScheme() {
      return new GetNewSeqTupleScheme();
    }
  }

  private static class GetNewSeqTupleScheme extends TupleScheme<GetNewSeq> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetNewSeq struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetNewSeq struct) throws org.apache.thrift.TException {
