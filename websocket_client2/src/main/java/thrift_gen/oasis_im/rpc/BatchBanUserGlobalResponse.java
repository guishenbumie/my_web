...
public class BatchBanUserGlobalResponse implements org.apache.thrift.TBase<BatchBanUserGlobalResponse, BatchBanUserGlobalResponse._Fields>, java.io.Serializable, Cloneable, Comparable<BatchBanUserGlobalResponse> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BatchBanUserGlobalResponse");
  ...
  static {
    schemes.put(StandardScheme.class, new BatchBanUserGlobalResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BatchBanUserGlobalResponseTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BatchBanUserGlobalResponse.class, metaDataMap);
  }

  public BatchBanUserGlobalResponse() {
  }
   ...
   */
  public BatchBanUserGlobalResponse(BatchBanUserGlobalResponse other) {
    if (other.isSetBase()) {
  ...
  public BatchBanUserGlobalResponse deepCopy() {
    return new BatchBanUserGlobalResponse(this);
  }
  ...
  public BatchBanUserGlobalResponse setBase(BaseResp base) {
    this.base = base;
    return this;
  }
  ...
  public BatchBanUserGlobalResponse setFailedUidList(List<String> failedUidList) {
    this.failedUidList = failedUidList;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BatchBanUserGlobalResponse)
      return this.equals((BatchBanUserGlobalResponse)that);
    return false;
  }

  public boolean equals(BatchBanUserGlobalResponse that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BatchBanUserGlobalResponse other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BatchBanUserGlobalResponse(");
    boolean first = true;
  ...
  private static class BatchBanUserGlobalResponseStandardSchemeFactory implements SchemeFactory {
    public BatchBanUserGlobalResponseStandardScheme getScheme() {
      return new BatchBanUserGlobalResponseStandardScheme();
    }
  }

  private static class BatchBanUserGlobalResponseStandardScheme extends StandardScheme<BatchBanUserGlobalResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BatchBanUserGlobalResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.failedUidList = new ArrayList<String>(_list78.size);
                String _elem79;
                for (int _i80 = 0; _i80 < _list78.size; ++_i80)
                {
                  _elem79 = iprot.readString();
                  struct.failedUidList.add(_elem79);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BatchBanUserGlobalResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.failedUidList != null) {
        oprot.writeFieldBegin(FAILED_UID_LIST_FIELD_DESC);
        {
          ...
          for (String _iter81 : struct.failedUidList)
          {
  ...
  private static class BatchBanUserGlobalResponseTupleSchemeFactory implements SchemeFactory {
    public BatchBanUserGlobalResponseTupleScheme getScheme() {
      return new BatchBanUserGlobalResponseTupleScheme();
    }
  }

  private static class BatchBanUserGlobalResponseTupleScheme extends TupleScheme<BatchBanUserGlobalResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BatchBanUserGlobalResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetFailedUidList()) {
        {
          ...
          for (String _iter82 : struct.failedUidList)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BatchBanUserGlobalResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.failedUidList = new ArrayList<String>(_list83.size);
          String _elem84;
          for (int _i85 = 0; _i85 < _list83.size; ++_i85)
          {
            _elem84 = iprot.readString();
            struct.failedUidList.add(_elem84);
          }
        }
        struct.setFailedUidListIsSet(true);
      }
