...
public class GlobalSessionInfo implements org.apache.thrift.TBase<GlobalSessionInfo, GlobalSessionInfo._Fields>, java.io.Serializable, Cloneable, Comparable<GlobalSessionInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GlobalSessionInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new GlobalSessionInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GlobalSessionInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GlobalSessionInfo.class, metaDataMap);
  }

  public GlobalSessionInfo() {
  }
   ...
   */
  public GlobalSessionInfo(GlobalSessionInfo other) {
  ...
  public GlobalSessionInfo deepCopy() {
    return new GlobalSessionInfo(this);
  }
  ...
  public GlobalSessionInfo setServerId(String serverId) {
    this.serverId = serverId;
    return this;
  }
  ...
  public GlobalSessionInfo setSeq(long seq) {
    this.seq = seq;
    setSeqIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GlobalSessionInfo)
      return this.equals((GlobalSessionInfo)that);
    return false;
  }

  public boolean equals(GlobalSessionInfo that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GlobalSessionInfo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GlobalSessionInfo(");
    boolean first = true;
  ...
  private static class GlobalSessionInfoStandardSchemeFactory implements SchemeFactory {
    public GlobalSessionInfoStandardScheme getScheme() {
      return new GlobalSessionInfoStandardScheme();
    }
  }

  private static class GlobalSessionInfoStandardScheme extends StandardScheme<GlobalSessionInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GlobalSessionInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GlobalSessionInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GlobalSessionInfoTupleSchemeFactory implements SchemeFactory {
    public GlobalSessionInfoTupleScheme getScheme() {
      return new GlobalSessionInfoTupleScheme();
    }
  }

  private static class GlobalSessionInfoTupleScheme extends TupleScheme<GlobalSessionInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GlobalSessionInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GlobalSessionInfo struct) throws org.apache.thrift.TException {
