...
public class GetNewestSeqResp implements org.apache.thrift.TBase<GetNewestSeqResp, GetNewestSeqResp._Fields>, java.io.Serializable, Cloneable, Comparable<GetNewestSeqResp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GetNewestSeqResp");
  ...
  static {
    schemes.put(StandardScheme.class, new GetNewestSeqRespStandardSchemeFactory());
    schemes.put(TupleScheme.class, new GetNewestSeqRespTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GetNewestSeqResp.class, metaDataMap);
  }

  public GetNewestSeqResp() {
  }
   ...
   */
  public GetNewestSeqResp(GetNewestSeqResp other) {
  ...
  public GetNewestSeqResp deepCopy() {
    return new GetNewestSeqResp(this);
  }
  ...
  public GetNewestSeqResp setMsgIncr(int msgIncr) {
    this.msgIncr = msgIncr;
    setMsgIncrIsSet(true);
    return this;
  }
  ...
  public GetNewestSeqResp setErrCode(int errCode) {
    this.errCode = errCode;
    setErrCodeIsSet(true);
    return this;
  }
  ...
  public GetNewestSeqResp setErrMsg(String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public GetNewestSeqResp setSeq(long seq) {
    this.seq = seq;
    setSeqIsSet(true);
    return this;
  }
   ...
   * @see thrift_gen.oasis_im.rpc.SESSION_TYPE
   */
  public GetNewestSeqResp setMsgType(thrift_gen.oasis_im.rpc.SESSION_TYPE msgType) {
    this.msgType = msgType;
    return this;
  }
  ...
  public GetNewestSeqResp setSessionKey(String sessionKey) {
    this.sessionKey = sessionKey;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof GetNewestSeqResp)
      return this.equals((GetNewestSeqResp)that);
    return false;
  }

  public boolean equals(GetNewestSeqResp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(GetNewestSeqResp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("GetNewestSeqResp(");
    boolean first = true;
  ...
  private static class GetNewestSeqRespStandardSchemeFactory implements SchemeFactory {
    public GetNewestSeqRespStandardScheme getScheme() {
      return new GetNewestSeqRespStandardScheme();
    }
  }

  private static class GetNewestSeqRespStandardScheme extends StandardScheme<GetNewestSeqResp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GetNewestSeqResp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetNewestSeqResp struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GetNewestSeqRespTupleSchemeFactory implements SchemeFactory {
    public GetNewestSeqRespTupleScheme getScheme() {
      return new GetNewestSeqRespTupleScheme();
    }
  }

  private static class GetNewestSeqRespTupleScheme extends TupleScheme<GetNewestSeqResp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GetNewestSeqResp struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GetNewestSeqResp struct) throws org.apache.thrift.TException {
