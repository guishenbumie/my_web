...
public class BanUserInGroupResp implements org.apache.thrift.TBase<BanUserInGroupResp, BanUserInGroupResp._Fields>, java.io.Serializable, Cloneable, Comparable<BanUserInGroupResp> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("BanUserInGroupResp");
  ...
  static {
    schemes.put(StandardScheme.class, new BanUserInGroupRespStandardSchemeFactory());
    schemes.put(TupleScheme.class, new BanUserInGroupRespTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(BanUserInGroupResp.class, metaDataMap);
  }

  public BanUserInGroupResp() {
  }
   ...
   */
  public BanUserInGroupResp(BanUserInGroupResp other) {
  ...
  public BanUserInGroupResp deepCopy() {
    return new BanUserInGroupResp(this);
  }
  ...
  public BanUserInGroupResp setMsgIncr(int msgIncr) {
    this.msgIncr = msgIncr;
    setMsgIncrIsSet(true);
    return this;
  }
  ...
  public BanUserInGroupResp setErrCode(int errCode) {
    this.errCode = errCode;
    setErrCodeIsSet(true);
    return this;
  }
  ...
  public BanUserInGroupResp setErrMsg(String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof BanUserInGroupResp)
      return this.equals((BanUserInGroupResp)that);
    return false;
  }

  public boolean equals(BanUserInGroupResp that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(BanUserInGroupResp other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("BanUserInGroupResp(");
    boolean first = true;
  ...
  private static class BanUserInGroupRespStandardSchemeFactory implements SchemeFactory {
    public BanUserInGroupRespStandardScheme getScheme() {
      return new BanUserInGroupRespStandardScheme();
    }
  }

  private static class BanUserInGroupRespStandardScheme extends StandardScheme<BanUserInGroupResp> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, BanUserInGroupResp struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BanUserInGroupResp struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BanUserInGroupRespTupleSchemeFactory implements SchemeFactory {
    public BanUserInGroupRespTupleScheme getScheme() {
      return new BanUserInGroupRespTupleScheme();
    }
  }

  private static class BanUserInGroupRespTupleScheme extends TupleScheme<BanUserInGroupResp> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, BanUserInGroupResp struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, BanUserInGroupResp struct) throws org.apache.thrift.TException {
